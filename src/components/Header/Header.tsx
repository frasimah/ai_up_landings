...
export { default } from "./HeaderStable";
         ...
         <div className="container">
            <div className={styles.header_wrap}>
               ...
               >
                  <ul>
                     <li>
                        <Link href={SITE_ROUTES.howWork}>
                           Как это работает
                        </Link>
                     </li>
                     <li>
                        <Link href={SITE_ROUTES.callCenter}>
                           Колл-центр
                        </Link>
                     </li>
                     <li>
                        <Link href={SITE_ROUTES.cost}>
                           Стоимость услуг
                        </Link>
                     </li>
                     <li>
                        <Link href={SITE_ROUTES.knowledgeBase}>
                           База знаний
                        </Link>
                     </li>
                     <li>
                        <Link href={SITE_ROUTES.blog}>
                           Блог
                        </Link>
                     </li>
                     <li>
               ...
               <div className={styles.header_wrap_right}>
                  <Button variant={'black'} noBorder={false} href={APP_ROUTES.signIn}>
                     Войти
                  </Button>
                  <Button variant={'blue'} noBorder={false} href={APP_ROUTES.signUp}>
                     Создать аккаунт
                  </Button>
                  <button
                     type="button"
