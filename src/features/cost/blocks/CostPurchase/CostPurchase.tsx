...
import styles from './CostPurchase.module.scss'
               ...
               <div className="col-xl-3">
                  <div className={styles.cost_purchase_wrap_main}>
                     <h2 className={styles.cost_purchase_wrap_main_title}>
                        Стоимость зависит только
                        от разовой покупки:
                     </h2>
                     <h2 className={styles.cost_purchase_wrap_main_bottom}>
                        <div className={styles.cost_purchase_wrap_main_bottom_text}>
                           <p>
                              Чем больше объём —
                              тем сильнее экономия
                           </p>
                        </div>
                     ...
                     <tbody>
                        {purchaseRows.map((row) => (
                           <tr
                              ...
                              className={row.status === 'vip' ? styles.vipRow : undefined}
                           >
                              <td>
                                 {row.status === 'vip' ? (
