...
const CASES: CaseCard[] = [
   ...
   },
   {
      ...
      quote: "«Директ дорожает, масштабировать невозможно, бригада простаивает». За месяц мы снизили стоимость квалифицированного лида с 2 800 до 380 рублей, а сделок стало в 6 раз больше.",
