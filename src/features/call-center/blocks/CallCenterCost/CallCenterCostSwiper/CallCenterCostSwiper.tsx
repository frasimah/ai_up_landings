...
import styles from "./CallCenterCostSwiper.module.scss";
...
function CallCenterCostSwiper() {
   const dataSw = [
      "услуги связи",
      "постоянно сменяемые номера",
      "инфраструктура",
      "маркировка",
   ];
   ...
   return (
      <div ref={sliderRef} className={styles.call_center_cost_slider}>
         ...
         <div className={styles.call_center_cost_slider_message}>
...
export default CallCenterCostSwiper;
